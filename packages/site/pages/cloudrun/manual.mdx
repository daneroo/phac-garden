...
./hey_linux_amd64 -n 10000 -c 100 https://time-go-2m3hexrmga-nn.a.run.app |grep 'Requests/sec'
./hey_linux_amd64 -n 10000 -c 100 https://time-deno-2m3hexrmga-nn.a.run.app |grep 'Requests/sec'
```
